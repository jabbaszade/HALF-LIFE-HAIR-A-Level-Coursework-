...
#It also takes wrong inputs and allows for retries after showing an error box.
        ...
        #Calling the function which compares the entered details with details in the database
        accessGiven = bs_checkLogin(UserEntered,PassEntered)

        if accessGiven == True:

            #User allowed to proceed and advance.
            ...
            #If the credentials given are incorrect, an error box is displayed
...
######## Homepage ########
    ...
    app.setSize("900x600")
    app.setBg("#152b6d")
    app.addLabel("home_title", "Welcome"+currentUserFirstName+"!", 0, 0)
