...
#This function checks which button has been pressed and acts accordingly on the login page, making the current window close and the chosen one to open..
...
#In the user table and either allows the user through or does not, however I have yet to code the validation and it allows the user in regardless of the input
#But it does print the input it has stored so I can ensure it does store the inputs (part of my testing). In addition to validation of username and password
#I will ensure it also takes wrong inputs and allows for retries after showing an error box.
...
######## Homepage ########
    ...
    app.setSize("900x600")
    app.setBg("#152b6d")
    app.addLabel("home_title", "Welcome username!")
