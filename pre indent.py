...
def barberCancelCheck(button): #This functions checks

    global barberCancelBID #Creating a global variable to store
...
######## Cancel Booking Page Part 2 ########
    ...
    app.setLabelFg("cancel_guide_2","#ff8039")
...
######## Settings Page ########
    ...
    app.setButtonFg("Change Password","#152b6d")
    app.setButtonFg("Edit Details","#152b6d")
    app.setButtonBg("Change Password","#ff8039")
    app.setButtonBg("Edit Details","#ff8039")
...
######## Barber Change Details Page ########
    ...
    app.addLabel("changeDetails_title","Edit Details")
    ...
    app.setLabelFg("changeDetails_title","#ff8039")
